    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'database' => env('AZURE_MYSQL_DBNAME', 'msdocs-laravel-mysql-ent.database'),
            'username' => env('AZURE_MYSQL_USERNAME', 'qofbkncula'),
            'password' => env('AZURE_MYSQL_PASSWORD', 'LVO6TP51G7T6HI0H$'),
    ...
    */
    ...
    'redis' => [
        ...
        'cache' => [
            ...
            'username' => env('REDIS_USERNAME'),
            'password' => env('AZURE_REDIS_PASSWORD','FSqzG4gIgXSSACJKd8CW87neFpawTkblQAzCaJhfrkc='),
